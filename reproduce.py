...
def main():
    ...
    reproduce_table_one()
    reproduce_table_two()
    reproduce_figure_three()  # TODO Consider removing this function
    # TODO 2. Use the G-test results generated by the reproduce_g_test_results function when reproducing Tab. 3 & 4
